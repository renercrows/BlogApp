...
User.create(name: 'Tiago',
    ...
    bio: 'Teacher from Brazil.', email: 'tiago@gmail.com', password: '123456', role: 'admin')
User.create(name: 'Jake',
    photo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgGzZ0z42r96DLQES7kolpBPw5xM2UqS04GKKYyZiF&s',
    bio: 'Teacher from Eritrea.', email: 'jake@gmail.com', password: '123456', role: 'admin')
User.create(name: 'Lui',
    photo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgGzZ0z42r96DLQES7kolpBPw5xM2UqS04GKKYyZiF&s',
    bio: 'Teacher from Thailand.', email: 'lui@gmail.com', password: '123456', role: 'admin')
